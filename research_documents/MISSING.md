...
Source: derived from `INDEX.md`. 12 items not yet obtained; 6 already downloaded.
...
| # | Citation | Notes |
|---|---|---|
| 8 | Wood, Freestone & Stapleton (1999). Polychrome glazes on a Warring States ceramic bead. *ISAC 99*, Shanghai. | Conference paper; not online |
| 9 | Henderson, An & Ma (2018). Archaeometry of Ancient Chinese Glass: Review. | Venue unclear in source |
| 10 | Liu, Robert K. *Zhou Silicate Beads: Shared Technologies.* | Venue unclear |

## Books & Web Essays

| # | Citation | URL | Notes |
|---|---|---|---|
| 11 | Braghin, C. ed. (2002). *Chinese Glass: Archaeological Studies…* Olschki. | https://www.worldcat.org/title/.../51477334 | Book — library loan |
| 12 | Mitsopoulou. *Eye-Shaped and Horned Glass Beads from China and Greece.* | https://www.greecetravel.com/archaeology/mitsopoulou/glass.html | Web essay (not PDF) |

## Suggested Legitimate Routes

- **Institutional access / ILL** — most reliable for items 1–7.
- **Author preprints** — check personal pages, ResearchGate, academia.edu.
- **Corresponding-author email** — common and successful for archaeometry papers.
- **Open-access versions** — search Google Scholar "All versions" and OpenAIRE.
- **HathiTrust / WorldCat** — for item 11.
